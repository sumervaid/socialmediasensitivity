...
context_plot_data$sample[context_plot_data$sample == 'Fall'] <- 'Exploratory'
context_plot_data$sample[context_plot_data$sample == 'Spring'] <- 'Confirmatory'
...
p1<-ggplot(data=context_plot_data, aes(x=reorder(Context, +contextValsProp), y=contextValsProp, group=sampleFactor, color=sampleFactor)) +  geom_point(size=8)+theme_apa() + xlab("Context") + ylab("Percent of all Observations") + theme(
...
ggsave("ContextPercentages.png", width=10, height=10) 
...
plot1_data_x$sample[plot1_data_x$sample == 'Fall'] <- 'Exploratory'
plot1_data_x$sample[plot1_data_x$sample == 'Spring'] <- 'Confirmatory'

plot1_data_x$sampleFactor<-factor(plot1_data_x$sample)

p2<-ggplot(data=plot1_data_x, aes(x=reorder(Context, +meanUse), y=meanUse, group=sampleFactor, color=sampleFactor)) +  geom_point(size=8)+theme_apa()+theme(
    axis.text.x = element_text(size=40), 
    axis.text.y=element_text(size=40),
    axis.title.y=element_text(size=41), 
    axis.title.x=element_text(size=41),
    legend.text=element_text(size=41)
  )+
  xlab("") +
  ylab("Mean Frequency of Social Media Use (%)") + coord_flip() + scale_y_continuous(limits=c(0,100), breaks=seq(0, 100, 20))

ggsave("Social Media Frequency by Context Social - Sample Specific.png", width=18, height=15) 

plot1_data_y<- plot1_data %>%
  dplyr::filter(Context1=='Physical')

plot1_data_y$sample[plot1_data_y$sample == 'Fall'] <- 'Exploratory'
plot1_data_y$sample[plot1_data_y$sample == 'Spring'] <- 'Confirmatory'

plot1_data_y$sampleFactor<-factor(plot1_data_y$sample)

p2<-ggplot(data=plot1_data_y, aes(x=reorder(Context, +meanUse), y=meanUse, group=sampleFactor, color=sampleFactor)) +  geom_point(size=8)+theme_apa()+theme(
    axis.text.x = element_text(size=40), 
    axis.text.y=element_text(size=40),
    axis.title.y=element_text(size=41), 
    axis.title.x=element_text(size=41),
...
ggsave("Social Media Frequency by Context Physical - Sample Specific.png", width=18, height=15) 
...
p3<-ggplot(data=plot1_data_x, aes(x=reorder(Context, +meanDuration), y=meanDuration, group=sampleFactor, color=sampleFactor)) +  geom_point(size=8)+theme_apa()+theme(
    axis.text.x = element_text(size=40), 
    axis.text.y=element_text(size=40),
    axis.title.y=element_text(size=41), 
    axis.title.x=element_text(size=41),
    legend.text=element_text(size=41))+
  xlab("") +
  ylab("Mean Duration of Social Media Use (Minutes)") + coord_flip() + scale_y_continuous(limits=c(0,4), labels=c("<1","1-15",  "16-30", "30-45",  "46-60")) 

ggsave("Social Media Use Duration by Context Social - Sample Specific.png", width=18, height=15) 
...
p4<-ggplot(data=plot1_data_y, aes(x=reorder(Context, +meanDuration), y=meanDuration, group=sampleFactor, color=sampleFactor)) +  geom_point(size=8)+theme_apa()+theme(
    axis.text.x = element_text(size=40), 
    axis.text.y=element_text(size=40),
    axis.title.y=element_text(size=41), 
    axis.title.x=element_text(size=41),
...
ggsave("Social Media Use Duration by Context Physical - Sample Specific.png", width=18, height=15) 
```