...
library(lubridate)
library(jtools)
setwd("~/Desktop/OneDrive - Stanford/CoCo - Social Media Use and Psychological Wellbeing/IdiographicWellbeing/DigitalMediaEffects/Data Prep - Preregistration")
...
write.csv(main_effect_updated, file="modelling_data_exploratory_replicate.csv")
```
