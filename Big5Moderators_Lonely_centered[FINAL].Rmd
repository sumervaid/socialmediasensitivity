...
int<-sim_slopes(openness_sm, pred=MediaUse.scaled, modx=openness.z, jnplot = TRUE)
plot<-interact_plot(openness_sm, pred=MediaUse.scaled, modx=openness.z) +xlab("Social Media Use (WP)") +ylab("Lonely (R)")+theme_apa()+ggtitle("BFI: Openness")
plot
ggsave("Openess Moderator - Use.png")
int$jnplot
ggsave("Openess Moderator - Use - JN Plot.png")
